## I used below Script to import users from csv file to Active directory OU.
-------------------------------------------------------------------
# Import active directory module for running AD cmdlets
Import-Module ActiveDirectory

# Store the data from NewUsersFinal.csv in the $ADUsers variable
$ADUsers = Import-Csv "C:\temp\Create bulk of AD users.csv" -Delimiter ";"
...
## below powershell command is for creating mailboxes.
